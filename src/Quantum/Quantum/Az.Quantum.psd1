#
# Module manifest for module 'Az.Quantum'
#
...
RequiredAssemblies = 'Quantum.Autorest/bin/Az.Quantum.private.dll'
...
FormatsToProcess = 'Quantum.Autorest/Az.Quantum.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('Quantum.Autorest/Az.Quantum.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzQuantumOffering', 'Get-AzQuantumWorkspace', 
               'New-AzQuantumProviderObject', 'New-AzQuantumWorkspace', 
