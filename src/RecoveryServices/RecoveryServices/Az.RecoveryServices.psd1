...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Deprecated the ''Token'' parameter for cross-tenant authentication in MUA scenarios for handling breaking change in Get-AzAccessToken cmdlet, use parameter ''SecureToken'' going forward.'
